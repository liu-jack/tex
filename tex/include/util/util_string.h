...
template<> struct lexical_castor <bool> {
    static bool cast(const string &s)
    {
        return lexical_castor<uint64_t>::cast(s) ? true : false;
    }
};

template<> struct lexical_castor <int8_t> {
    static int8_t cast(const string &s)
    {
        return static_cast<int8_t>(lexical_castor<uint64_t>::cast(s));
    }
};

template<> struct lexical_castor <uint8_t> {
    static uint8_t cast(const string &s)
    {
        return static_cast<uint8_t>(lexical_castor<uint64_t>::cast(s));
    }
};

template<> struct lexical_castor <int16_t> {
    static int16_t cast(const string &s)
    {
        return static_cast<int16_t>(lexical_castor<uint64_t>::cast(s));
    }
};

template<> struct lexical_castor <uint16_t> {
    static uint16_t cast(const string &s)
    {
        return static_cast<uint16_t>(lexical_castor<uint64_t>::cast(s));
    }
};

template<> struct lexical_castor <int32_t> {
    static int32_t cast(const string &s)
    {
        return static_cast<int32_t>(lexical_castor<uint64_t>::cast(s));
    }
};

template<> struct lexical_castor <uint32_t> {
    static uint32_t cast(const string &s)
    {
        return static_cast<uint32_t>(lexical_castor<uint64_t>::cast(s));
    }
};

template<> struct lexical_castor <int64_t> {
    static int64_t cast(const string &s)
    {
        return static_cast<int64_t>(lexical_castor<uint64_t>::cast(s));
    }
};
