...
public:
    ...
    const vector<string> &getAllItem() const
    {
        return m_vItem;
    }
    const vector<string> &getAllItem(const string &sPath) const
    {
        return getSubConfig(sPath).getAllItem();
    }
    const map<string, string> &getAllKeyValue() const
    {
        return m_mKeyValue;
    }
    const map<string, string> &getAllKeyValue(const string &sPath) const
    {
        return getSubConfig(sPath).getAllKeyValue();
    }
    const map<string, CConfig> &getAllSubConfig() const
    {
        return m_mSubConfig;
    }
    const map<string, CConfig> &getAllSubConfig(const string &sPath) const
    {
        return getSubConfig(sPath).getAllSubConfig();
    }
