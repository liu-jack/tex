...
struct RedisReply {
    ...
    bool isNull() const
    {
        return type == RedisReplyType_Null;
    }
    bool isStatus() const
    {
        return type == RedisReplyType_Status;
    }
    bool isError() const
    {
        return type == RedisReplyType_Error;
    }
    bool isString() const
    {
        return type == RedisReplyType_String;
    }
    bool isArray() const
    {
        return type == RedisReplyType_Array;
    }
    bool isInteger() const
    {
        return type == RedisReplyType_Integer;
    }
    void reset()
    {
        type = RedisReplyType_Null;
        integer = 0;
        len = 0;
        str = NULL;
        elements = 0;
...
public:
    explicit CRedisReplyDecoder(const string &sData)
    {
        init(sData.c_str(), sData.c_str() + sData.size());
    }
    CRedisReplyDecoder(const char *pBegin, const char *pEnd)
    {
        init(pBegin, pEnd);
    }
    ...
    bool isNeedMore()
    {
        return m_res == DecodeRes_Less;
    }
    bool isEnd() const
    {
        return m_pNextBegin >= m_pEnd;
    }
    RedisReply &getCurReply()
    {
        return m_curReply;
    }
    const char *getContentBegin() const
    {
        return m_pContentBegin;
    }
    const char *getContentEnd() const
    {
        return m_pContentEnd;
    }
    const char *getNextBegin() const
    {
        return m_pNextBegin;
    }
...
public:
    ...
    void setCmdNum(uint32_t iCmdNum)
    {
        m_iCmdNum = iCmdNum;
    }
