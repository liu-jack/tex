...
{
    if (s == "RedisResult_NoData") {
        e = RedisResult_NoData;
        return true;
    }
    return false;
}
...
{
public:
    tr1::shared_ptr<RedisPrxCallback> shared_from_this()
    {
        return tr1::static_pointer_cast<RedisPrxCallback>(tr1::enable_shared_from_this<ServiceProxyCallback>::shared_from_this());
    }
