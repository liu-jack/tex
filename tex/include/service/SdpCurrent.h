...
public:
    ...
    void setResponseContext(const map<string, string> &context)
    {
        m_responseContext = context;
    }
    const map<string, string> &getResponseContext() const
    {
        return m_responseContext;
    }
    map<string, string> &getResponseContext()
    {
        return m_responseContext;
    }
    ...
    {
        return m_request.sServiceName;
    }
    const string &getFuncName() const
    {
        return m_request.sFuncName;
    }
    const string &getRequestBuffer() const
    {
        return m_request.sReqPayload;
    }
    uint32_t getRequestTimeout() const
    {
        return m_request.iTimeout;
    }
    ...
    {
        return m_request.iRequestId;
    }
    bool isOneWay() const
    {
        return m_request.bIsOneWay;
    }
    ...
    void setUserData1(uint64_t val)
    {
        m_iUserData1 = val;
    }
    ...
    void setUserData2(uint64_t val)
    {
        m_iUserData2 = val;
    }
