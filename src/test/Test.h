...
{
	if (s == "NUMBER_1") { e = NUMBER_1; return true; }
	if (s == "NUMBER_2") { e = NUMBER_2; return true; }
	return false;
}
...
struct Student
{
	...
	const char *getName() const { return "Student"; } 
	template <typename T>
...
struct Teacher
{
	...
	const char *getName() const { return "Teacher"; } 
	template <typename T>
	void visit(T &t, bool bOpt) 
	{
		if (!bOpt)
...
struct Teachers
{
	...
	Teachers() {}
	const char *getName() const { return "Teachers"; } 
	template <typename T>
	void visit(T &t, bool bOpt) 
	{
		if (!bOpt)
...
namespace std
{
inline void swap(Test::Student &a, Test::Student &b) { a.swap(b); }
inline void swap(Test::Teacher &a, Test::Teacher &b) { a.swap(b); }
inline void swap(Test::Teachers &a, Test::Teachers &b) { a.swap(b); }
inline void swap(Test::Class &a, Test::Class &b) { a.swap(b); }
}
