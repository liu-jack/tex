...
public:
    bool operator<(const LuaValue &b) const
    {
        ...
        case LuaValueType_Boolean:
            return m_valBool < b.m_valBool;
        case LuaValueType_Number:
            return m_valNumber < b.m_valNumber;
        case LuaValueType_String:
            return m_valString < b.m_valString;
        case LuaValueType_Table:
            return m_valTable < b.m_valTable;
        }
        return false;
    }
...
public:
    ...
    bool isNil() const
    {
        return m_type == LuaValueType_Nil;
    }
    bool isBoolean() const
    {
        return m_type == LuaValueType_Boolean;
    }
    bool isNumber() const
    {
        return m_type == LuaValueType_Number;
    }
    bool isString() const
    {
        return m_type == LuaValueType_String;
    }
    bool isTable() const
    {
        return m_type == LuaValueType_Table;
    }
...
template <> struct LuaValueCast <bool> {
    static bool cast(const LuaValue &stValue)
    {
        ...
        case LuaValue::LuaValueType_Nil:
            return false;
        case LuaValue::LuaValueType_Boolean:
            return stValue.m_valBool;
        case LuaValue::LuaValueType_Number:
            return stValue.m_valNumber != 0.0;
        case LuaValue::LuaValueType_String:
            return UtilString::strto<bool>(stValue.m_valString);
        case LuaValue::LuaValueType_Table:
            throw std::runtime_error("lua table cannot cast to boolean");
            return false;
        }
        return false;
    }
...
template <> struct LuaValueCast <uint64_t> {
    static uint64_t cast(const LuaValue &stValue)
    {
        ...
        case LuaValue::LuaValueType_Nil:
            return 0;
        case LuaValue::LuaValueType_Boolean:
            return stValue.m_valBool ? 1 : 0;
        case LuaValue::LuaValueType_Number:
            return (uint64_t)stValue.m_valNumber;
        case LuaValue::LuaValueType_String:
            return UtilString::strto<uint64_t>(stValue.m_valString);
        case LuaValue::LuaValueType_Table:
            throw std::runtime_error("lua table cannot cast to number");
            return 0;
        }
        return 0;
    }
...
template<> struct LuaValueCast <double> {
    static double cast(const LuaValue &stValue)
    {
        ...
        case LuaValue::LuaValueType_Nil:
            return 0.0;
        case LuaValue::LuaValueType_Boolean:
            return stValue.m_valBool ? 1.0 : 0.0;
        case LuaValue::LuaValueType_Number:
            return stValue.m_valNumber;
        case LuaValue::LuaValueType_String:
            return UtilString::strto<double>(stValue.m_valString);
        case LuaValue::LuaValueType_Table:
            throw std::runtime_error("lua table cannot cast to number");
            return 0.0;
        }
...
template<> struct LuaValueCast <string> {
    static string cast(const LuaValue &stValue)
    {
        ...
        case LuaValue::LuaValueType_Boolean:
            return stValue.m_valBool ? "1" : "0";
        case LuaValue::LuaValueType_Number:
            return UtilString::tostr(stValue.m_valNumber);
        case LuaValue::LuaValueType_String:
            return stValue.m_valString;
        case LuaValue::LuaValueType_Table:
            throw std::runtime_error("lua table cannot cast to string");
            return "";
        }
        return "";
    }
...
template <> struct LuaValueCast <int8_t> {
    static int8_t cast(const LuaValue &stValue)
    {
        return static_cast<int8_t>(LuaValueCast<uint64_t>::cast(stValue));
    }
};

template<> struct LuaValueCast <uint8_t> {
    static uint8_t cast(const LuaValue &stValue)
    {
        return static_cast<uint8_t>(LuaValueCast<uint64_t>::cast(stValue));
    }
};

template<> struct LuaValueCast <int16_t> {
    static int16_t cast(const LuaValue &stValue)
    {
        return static_cast<int16_t>(LuaValueCast<uint64_t>::cast(stValue));
    }
};

template<> struct LuaValueCast <uint16_t> {
    static uint16_t cast(const LuaValue &stValue)
    {
        return static_cast<uint16_t>(LuaValueCast<uint64_t>::cast(stValue));
    }
};

template<> struct LuaValueCast <int32_t> {
    static int32_t cast(const LuaValue &stValue)
    {
        return static_cast<int32_t>(LuaValueCast<uint64_t>::cast(stValue));
    }
};

template<> struct LuaValueCast <uint32_t> {
    static uint32_t cast(const LuaValue &stValue)
    {
        return static_cast<uint32_t>(LuaValueCast<uint64_t>::cast(stValue));
    }
};

template<> struct LuaValueCast <int64_t> {
    static int64_t cast(const LuaValue &stValue)
    {
        return static_cast<int64_t>(LuaValueCast<uint64_t>::cast(stValue));
    }
};

template<> struct LuaValueCast <float> {
    static float cast(const LuaValue &stValue)
    {
        return static_cast<float>(LuaValueCast<double>::cast(stValue));
    }
};
...
public:
    ...
    void peek(int idx, bool &v)
    {
        v = toboolean(idx);
    }
    void peek(int idx, char &v)
    {
        v = (char)tointeger(idx);
    }
    void peek(int idx, int8_t &v)
    {
        v = (int8_t)tointeger(idx);
    }
    void peek(int idx, uint8_t &v)
    {
        v = (uint8_t)tointeger(idx);
    }
    void peek(int idx, int16_t &v)
    {
        v = (int16_t)tointeger(idx);
    }
    void peek(int idx, uint16_t &v)
    {
        v = (uint16_t)tointeger(idx);
    }
    void peek(int idx, int32_t &v)
    {
        v = tointeger(idx);
    }
    void peek(int idx, uint32_t &v)
    {
        v = (uint32_t)tonumber(idx);
    }
    void peek(int idx, int64_t &v);
    void peek(int idx, uint64_t &v);
    void peek(int idx, float &v)
    {
        v = (float)tonumber(idx);
    }
    void peek(int idx, double &v)
    {
        v = tonumber(idx);
    }
    void peek(int idx, string &v)
    {
        v = tostring(idx);
    }
