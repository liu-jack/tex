...
public:
	...
	const ProgressInfo &getProgress() const { return m_stProgressInfo; }
	const string &getLogFileName() const { return m_sLogFileName; }
...
public:
	...
	void setVariable(const map<string, string> &mVariable) { m_stSyncConfig.mVariable = mVariable; }
