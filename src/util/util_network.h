...
public:
    ...
    bool isValid() const
    {
        return m_type != EndpointType_Invalid;
    }
    bool isTcp() const
    {
        return m_type == EndpointType_Tcp4;
    }
    bool isUdp() const
    {
        return m_type == EndpointType_Udp4;
    }
    bool isUnix() const
    {
        return m_type == EndpointType_Unix;
    }
