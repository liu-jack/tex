...
public:
    ...
    void setCurrent(const SdpCurrentPtr &current)
    {
        m_current = current;
    }
    void unsetCurrent()
    ...
    virtual int handleNoMfwRequest(const string &/*sReqPayload*/, string &/*sRspPayload*/)
    {
        return -1;
    }
