...
public:
    ...
    const string &getSubType1() const
    {
        return m_sSubType1;
    }
    const string &getSubType2() const
    {
        return m_sSubType2;
    }
...
public:
    ...
    {
        return m_newval.get() != NULL;
    }
    zval *getNewValue() const
    {
        return m_newval.get();
    }
    zval *takeNewValue()
    {
        return m_newval.take();
    }
