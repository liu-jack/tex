...
private:
	...
	static string getSdpTypeName(const SdpType &stType)
	{
		...
		{
		case SdpType_Bool: return "sdp.Boolean";
		case SdpType_Char: return "sdp.Char";
		case SdpType_Int8: return "sdp.Int8";
		case SdpType_UInt8: return "sdp.Uint8";
		case SdpType_Int16: return "sdp.Int16";
		case SdpType_UInt16: return "sdp.Uint16";
		case SdpType_Int32: return "sdp.Int32";
		case SdpType_UInt32: return "sdp.Uint32";
		case SdpType_Int64: return "sdp.Int64";
		case SdpType_UInt64: return "sdp.Uint64";
		case SdpType_Float: return "sdp.Float";
		case SdpType_Double: return "sdp.Double";
		case SdpType_String: return "sdp.String";
		case SdpType_Vector:
			{
    ...
    static string getSdpFieldFunName(const SdpType &stType) {
		...
		case SdpType_Char: return "Uint8";
		case SdpType_Int8: return "Int8";
		case SdpType_UInt8: return "Uint8";
		case SdpType_Int16: return "Int16";
		case SdpType_UInt16: return "Uint16";
		case SdpType_Int32: return "Int32";
		case SdpType_UInt32: return "Uint32";
		case SdpType_Int64: return "Int64";
		case SdpType_UInt64: return "Uint64";
		...
		case SdpType_Map: return "Map";
		case SdpType_Struct: return "Struct";
        }
		return "";
    }
